...
export const Products = () => {
  ...
  async function setGender(event) {
    ...
    const JavaScriptApplicants = d.filter((e) =>
      e.gender.includes(event.target.value)
    );
  ...
  async function setCat(event) {
    ...
    const JavaScriptApplicants = d.filter((e) =>
      e.category.includes(event.target.value)
    );
  ...
  async function setCol(event) {
    ...
    const JavaScriptApplicants = d.filter((e) =>
      e.color.includes(event.target.value)
    );
      ...
      <Filter>
        ...
        <div>
          ...
          <div onChange={setCat.bind(this)}>
            <input type="checkbox" name="skills" id="radio" value="jwellary" />{' '}
            Jwelarry
            <br />
            <input
              type="checkbox"
